...
;--------------------------------------------------
kprint .macro
     lda #\1                                     ; set x coordinate
     sta kernel.args.display.x
     lda #\2                                     ; set y coordinate
     sta kernel.args.display.y
     lda #<\3                                    ; set pointer to text data
     sta kernel.args.display.text
     lda #>\3
     sta kernel.args.display.text+1
     lda #\4                                     ; set text length
     sta kernel.args.display.buflen
     lda #<\5                                    ; set pointer to color data (one byte for each byte of text)
